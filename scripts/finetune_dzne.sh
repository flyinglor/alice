#!/bin/bash
#SBATCH -J ft_cls_adni_dzne_resize64^3_ckp0250_bs8_lr1e-4
#SBATCH -N 1
...
srun python main-finetune.py \
    ...
    --checkpoint_file "/dss/dssmcmlfs01/pr62la/pr62la-dss-0002/MSc/Hui/alice/adni/vitb_roi64/checkpoint0250.pth"
